...
{
    internal static class EnhancedTrap_Craftable
    {
        public static TechType techType;

        public static void Patch()
        {
            Sprite sprite = ImageUtils.LoadSpriteFromFile(Path.Combine(Main_Plugin.AssetsFolderPath, "EnhancedGravTrap.png"));
