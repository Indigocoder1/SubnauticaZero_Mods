...
namespace MirrorMod
{
    ...
    public class Main_Plugin : BaseUnityPlugin
    {
        ...
        {
            Sprite variant1Sprite = ImageUtils.LoadSpriteFromFile(Path.Combine(AssetsFolderPath, "MirrorVariant1.png"));
            ...
            Sprite variant2Sprite = ImageUtils.LoadSpriteFromFile(Path.Combine(AssetsFolderPath, "MirrorVariant2.png"));
